...
start %KBE_BIN_PATH%/baseapp.exe --cid=7002 --gus=8
start %KBE_BIN_PATH%/cellapp.exe --cid=8001 --gus=9
start %KBE_BIN_PATH%/cellapp.exe --cid=8002  --gus=10
start %KBE_BIN_PATH%/loginapp.exe --cid=9000 --gus=11
start %KBE_BIN_PATH%/loginapp.exe --cid=9001 --gus=12
start %KBE_BIN_PATH%/loginapp.exe --cid=9002 --gus=13
