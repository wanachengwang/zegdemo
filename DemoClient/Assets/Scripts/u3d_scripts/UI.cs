...
{
    const string ExtraClientData = "zegdemo";    //kbengine_unity3d_demo
	...
	public void login()
	{
		...
		KBEngine.Event.fireIn("login", stringAccount, stringPasswd, System.Text.Encoding.UTF8.GetBytes(ExtraClientData));
	}
	...
	public void createAccount()
	{
		...
		KBEngine.Event.fireIn("createAccount", stringAccount, stringPasswd, System.Text.Encoding.UTF8.GetBytes(ExtraClientData));
	}
